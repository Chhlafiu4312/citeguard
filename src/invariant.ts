/**
 * Package-owned invariant companion for `dsh-citeguard`.
 * @module dsh-citeguard/invariant
 */

import type { Context } from '@deepseek-ai/cordis'

const PACKAGE_NAME = 'dsh-citeguard'
...
export const name = 'citeguard-invariant'
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants']

/**
 * No runtime invariant: CiteGuard performs independent read-only checks and
